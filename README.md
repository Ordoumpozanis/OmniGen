this repo is forked from [OmniGen](https://github.com/VectorSpaceLab/OmniGen)]
also the quantization model is from https://huggingface.co/sdyy/OmniGen_quantization2/tree/main
